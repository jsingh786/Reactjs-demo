...
import createProposalEngineMiddleware from 'redux-saga'
...
let proposalEngineMiddleware = createProposalEngineMiddleware()

// Creates the Redux store using our reducer and the logger and saga middlewares
let store = createStore(reducer, applyMiddleware(logger, proposalEngineMiddleware))
// We run the root saga automatically
proposalEngineMiddleware.run(rootProposalEngine)
